...
- falsy values; A falsy value is a value that is considered false when encountered in a Boolean contex (Boolean's are a data type that can only be "true" or "false")
    ...
    -This ,eams when JavaScript is expecting a boolean and is given one of these values, it will always evaluate to "falsy"
