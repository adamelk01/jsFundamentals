...
// where arrays use square bracket notation to access properties, objects use what is call dot (.) notation
...
console.log(`episode name: ${netflix.season1.seasonInfo.episodeInfo[4].episodeName} - episode number: ${netflix.season1.seasonInfo.episodeInfo[4].episode}`);
...
/*
    JSON OBJECTS
        ...
        -JSON exists as a string.  JSON data is what we receive when we fetch data from a server.  Since JSON data is text only, it needs to be converted to a native JavaScript object if we want to beable to access and use the data
*/
